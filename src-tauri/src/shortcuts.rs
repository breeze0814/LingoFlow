...
mod desktop {
    ...
    impl ShortcutAction {
        fn tray_action(self) -> &'static str {
            match self {
                Self::InputTranslate => ACTION_INPUT_TRANSLATE,
                Self::OcrTranslate => ACTION_OCR_TRANSLATE,
                Self::HideInterface => "",
                Self::SelectionTranslate => ACTION_SELECTION_TRANSLATE,
                Self::OcrRecognize => ACTION_OCR_RECOGNIZE,
                Self::OpenSettings => ACTION_OPEN_SETTINGS,
            }
        }
