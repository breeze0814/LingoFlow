...
use crate::orchestrator::models::{TaskData, TaskRequest, TaskResponse};
use crate::orchestrator::ocr_text::normalize_ocr_text;
use crate::platform::capture::capture_interactive_image;
use crate::providers::traits::{OcrProvider, OcrRequest};

use super::{OcrExecution, Orchestrator, DEFAULT_OCR_TIMEOUT_MS};
...
impl Orchestrator {
    ...
    pub(super) async fn handle_ocr_recognize_from_image(
        &self,
        request: TaskRequest,
        image_path: String,
    ...
    pub(super) async fn handle_ocr_translate_from_image(
        &self,
        request: TaskRequest,
        image_path: String,
        capture_rect: crate::orchestrator::models::CaptureRect,
